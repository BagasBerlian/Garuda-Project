        ...
        return $form
            ->schema([
                Forms\Components\Wizard::make([
                    Wizard\Step::make('Flight Information')->schema([
                        Forms\Components\TextInput::make('flight_number')->required()->unique(ignoreRecord: true)->maxLength(255),
                        Forms\Components\Select::make('airline_id')->relationship('airline', 'name')->required(),
                    ]),
                    Wizard\Step::make('Flight Segment')->schema([
                    ...
                    Wizard\Step::make('Flight Class')->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('airlane.name'),
